...
export const metadata: Metadata = {
  ...
  description:
    "Build your formation · Plan skill order · Share with your friend. No sign-up, works on mobile and desktop.",
  ...
  twitter: {
    ...
    title: "7K Builder — Team Planner for Seven Knights Rebirth",
    description: "Build your formation · Plan skill order · Share with your friend. No sign-up, works on mobile and desktop.",
  },
};
